...
namespace CinemaClient.Migrations
{
    ...
    [Migration("20220506100620_ScreeningPrice")]
    partial class ScreeningPrice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaClient.Domain.CinemaRoom", b =>
                {
                    ...
                    b.Property<int?>("CurrentScreeningId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaClient.Domain.MovieScreening", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaClient.Domain.CinemaRoom", b =>
                {
                    b.HasOne("CinemaClient.Domain.MovieScreening", "CurrentScreening")
                        .WithMany()
                        .HasForeignKey("CurrentScreeningId");
            ...
            modelBuilder.Entity("CinemaClient.Domain.Ticket", b =>
                {
                    b.HasOne("CinemaClient.Domain.MovieScreening", "Screening")
                        .WithMany("Tickets")
                        .HasForeignKey("ScreeningId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CinemaClient.Domain.Spectator", "Spectator")
                        .WithMany()
